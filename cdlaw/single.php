						...
						<div class="blog_single_holder">	
							<article>
								<div class="blog_title_holder">
									 ...
									 <?php } ?>
									 <span class="create"><span><?php the_time('d M Y'); ?>, <?php _e('by','qode'); ?> <span class="blog_author"><?php the_author(); ?></span> <?php _e('in','qode'); ?> <span class="category"><?php the_category(', '); ?></span></span>
									</span>
								</div>
