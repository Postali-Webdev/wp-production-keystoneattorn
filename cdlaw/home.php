				...
				<?php switch ($qode_options_passage['blog_style']) {
					case 1: ?>
						<?php if ( function_exists('yoast_breadcrumb') ) {yoast_breadcrumb('<p id="breadcrumbs">','</p>');} ?> 
							<h1 class="diamond_red">Legal Blog</h1>
										...
										<div class="post_text_holder">
											<div class="post_text_inner">
												...
												<span class="info">
													...
													<?php } ?>
													<span class="right"><a href="<?php the_permalink(); ?>" class="read_more">Read more <i class="wp-svg-custom-circle-arrow circle-arrow"></i></a></span>
												</span>
											</div>
										</div>	
									</article>
